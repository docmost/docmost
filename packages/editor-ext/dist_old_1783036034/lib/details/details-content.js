    ...
    addKeyboardShortcuts() {
        return {
            Enter: ({ editor }) => {
                ...
                const findNode = (0, core_1.findParentNode)((node) => node.type.name === this.name)(selection);
                ...
                const nodeType = (0, core_1.defaultBlockAt)(rootNode.contentMatchAt(indexAfter));
                if (!nodeType ||
...
//# sourceMappingURL=details-content.js.map