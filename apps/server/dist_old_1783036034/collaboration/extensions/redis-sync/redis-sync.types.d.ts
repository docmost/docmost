...
export type RSAMessage = RSAMessageProxy | RSAMessageCloseProxy | RSAMessageUnload | RSAMessageClose | RSAMessagePing | RSAMessagePong | RSAMessageSend | RSAMessageCustomEventStart | RSAMessageCustomEventComplete;
export type Pack = (msg: RSAMessage) => string | Buffer<ArrayBufferLike>;
export type Unpack = (packedMessage: Uint8Array | Buffer<ArrayBufferLike>) => RSAMessage;
type ServerId = string;
type CustomEventName = string;
export type CustomEvents = Record<CustomEventName, (documentName: string, payload: unknown) => Promise<unknown>>;
