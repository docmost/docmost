...
async function up(db) {
    await db.schema
        ...
        .addColumn('verified_by_id', 'uuid', (col) => col.references('users.id').onDelete('set null'))
        .addColumn('expires_at', 'timestamptz')
        .addColumn('requested_at', 'timestamptz')
        .addColumn('requested_by_id', 'uuid', (col) => col.references('users.id').onDelete('set null'))
        .addColumn('rejected_at', 'timestamptz')
        .addColumn('rejected_by_id', 'uuid', (col) => col.references('users.id').onDelete('set null'))
    ...
    await db.schema
        ...
        .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo((0, kysely_1.sql) `gen_uuid_v7()`))
        .addColumn('page_verification_id', 'uuid', (col) => col.notNull().references('page_verifications.id').onDelete('cascade'))
    ...
    await db.schema
        ...
        .addColumn('page_verification_id', 'uuid', (col) => col.references('page_verifications.id').onDelete('cascade'))
        .execute();
}
...
//# sourceMappingURL=20260413T121647-page-verifications.js.map