...
async function up(db) {
    ...
    await db.schema
        ...
        .addColumn('type', (0, kysely_1.sql) `auth_provider_type`, (col) => col.notNull())
        ...
        .addColumn('allow_signup', 'boolean', (col) => col.defaultTo(false).notNull())
    ...
    await db.schema
        ...
        .addColumn('auth_provider_id', 'uuid', (col) => col.references('auth_providers.id').onDelete('cascade'))
        .addColumn('workspace_id', 'uuid', (col) => col.references('workspaces.id').onDelete('cascade').notNull())
        .addColumn('created_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addColumn('deleted_at', 'timestamptz', (col) => col)
...
//# sourceMappingURL=20250118T194658-sso-auth.js.map