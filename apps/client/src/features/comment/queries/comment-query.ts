...
export function useCreateCommentMutation() {
  ...
  return useMutation<IComment, Error, Partial<IComment>>({
    ...
    onError: (error) => {
      notifications.show({ message: t("Error creating comment"), color: "red" });
    },
  });
}
...
export function useUpdateCommentMutation() {
  ...
  return useMutation<IComment, Error, Partial<IComment>>({
    ...
    onError: (error) => {
      notifications.show({ message: t("Failed to update comment"), color: "red" });
    },
  });
}
...
export function useDeleteCommentMutation(pageId?: string) {
  ...
  return useMutation({
    ...
    onError: (error) => {
      notifications.show({ message: t("Failed to delete comment"), color: "red" });
    },
  });
}
