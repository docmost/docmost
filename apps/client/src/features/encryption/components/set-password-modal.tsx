  ...
  return (
    ...
    >
      ...
      >
        <Text size="sm">
          {t(
            "If you forget this password, the page content is permanently unrecoverable. Search, export, sharing and real-time collaboration are disabled for encrypted pages.",
          )}
        </Text>
      </Alert>
