...
/**
 * Render the ShareTarget page UI for importing shared content into a selected space and optional parent page.
 *
 * The component loads shared content (from a cache or URL params), allows choosing a space and parent page (with search and breadcrumb navigation), editing title/content, and importing the content as a new markdown page.
 *
 * @returns The rendered React element for the ShareTarget page.
 */
