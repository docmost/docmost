...
This project is indexed by GitNexus as **sc_doc** (10680 symbols, 28052 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
